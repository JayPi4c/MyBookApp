...
public class BookUpdatesController {
    ...
    public SseEmitter streamUpdates(@RequestParam String jobId) throws IOException {
        Optional<SseEmitter> emitterOpt = sseEmitterRegistry.get(UUID.fromString(jobId));
